...
<Callout type="info" title="Note">
  `ternSecureInstrumentation()` intercept firebase requests to add referer in the header. so firebaseServerApp wont thro auth/refer-empty error when render in SSR.
</Callout>
